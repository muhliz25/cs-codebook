	...
	public class StartForm: System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Controls.AddRange(new System.Windows.Forms.Control[] {
																		  ...
																		  this.pictureBox1});
			this.Name = "StartForm";
			this.Text = "Image in Byte-Array schreiben";
		...
		private void demoButton_Click(object sender, System.EventArgs e)
		{
			...
			// Um das Byte-Array zu testen daraus ein Bitmap-Objekt erzeugen und
			// diese in die rechte PictureBox schreiben
			MemoryStream imageStream = new MemoryStream(imageBytes, 0, imageBytes.Length);
			pictureBox2.Image = new Bitmap(imageStream);
			imageStream.Close();
		}
	}
}
