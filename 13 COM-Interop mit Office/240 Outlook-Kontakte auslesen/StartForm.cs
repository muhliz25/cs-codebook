...
namespace Outlook_Kontakte
{
	class Start
	{
		...
		{
			// Zunächst alle Elemente auslesen
			Console.WriteLine();
		...
		static void Main(string[] args)
		{
			...
			// Den Ordner "Persönliche Ordner/Kontakte/Handy-Kontakte" explizit 
			// referenzieren und auslesen
			string folderName1 = "Persönliche Ordner";
			...
			string rootFolderName = "Persönliche Ordner";
